...
const Newarrival = () => {
     const [products,set_products]=useState([
        ...
        const flash_products=()=>{
            axios.get(`https://surebdbackend.arbeittechnology.com/admin/new-arrival-products`)
            .then((res)=>{
                if(res.data.success){
  ...
  return (
   <section className='px-4 lg:px-10 xl:px-[80px] 2xl:px-[250px] pb-[20px] xl:pb-[50px] font-baji'>
      <div className='flex justify-between items-center'>
            <h2 className='flex justify-center items-center gap-[3px] text-[18px] lg:text-[23px] font-[600]'>New Arrival </h2>
