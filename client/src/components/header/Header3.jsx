...
const Header3 = () => {
  return (
    <section className=' px-[10px] md:px-[150px] pb-[5px] mt-[5px]'>

     <nav className='w-full h-[40px] lg:h-[50px] bg-white flex'>
       <div className='w-[180px] lg:w-[200px]  h-[100%] bg-[#43B18A] flex justify-center items-center text-white text-[12px] md:text-[16px] font-[500]'>
          <h1 className='font-quicksand font-[600]'>BigCommerce</h1>
       </div>
       <div className='w-full h-[100%] text-[13px] lg:text-[16px]  flex justify-center items-center text-black pl-[5px] '>
